...
OutIDFFilePath = 'setting/idf.txt'
...
if __name__ == "__main__":
    ...
    # 统计idf
    tfidf_vector = TfidfVectorizer(use_idf=True, smooth_idf=True, norm=None, max_features=1200, max_df = 0.5, min_df = 10) # max_df = 0.05, min_df = 15
